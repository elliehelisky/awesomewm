...
beautiful.init(gears.filesystem.get_configuration_dir() .. "elh.lua")
...
awful.screen.connect_for_each_screen(function(s)
  ...
  s.mywibox = awful.wibar({ border_width = 10, screen = s })
  s.mywibox.widget = {
...
globalkeys = gears.table.join(
  ...
  awful.key({ modkey, }, "x", function() awful.spawn("slock") end,
    { description = "lock the screen", group = "suckless" }),
  ...
  awful.key({ modkey, "Shift" }, "d", function() awful.spawn("j4-dmenu-desktop") end,
  ...
  awful.key({}, "Print", function() awful.spawn("flameshot gui --path /home/elh/Pictures/screenshots") end,
